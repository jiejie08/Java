...
import com.ld.checkstand.plus.impl.SimpleGoodsCenter;
import com.ld.checkstand.plus.impl.SimpleOrderCenter;
...
public class CheckStandPlus {
    ...
    public static void usage() {
        ...
        usageInfo();
        System.out.println(orderCenter.ordersTable(order.getOrderId()));
        while (true) {
